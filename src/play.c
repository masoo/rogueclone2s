...
play_level(void)
{
	...
	CH:
		...
		case 'v':
			...
			message("base by ...", 0);
			message("Rogue-clone: Version II. (Tim Stoehr was "
				"here), tektronix!zeus!tims ",
			    0);
			message("Japanese edition: Ver.1.3a (enhanced by "
				"ohta@src.ricoh.co.jp)",
			    0);
			message("Ver.1.3aS program bug fix/separate (by "
...
extern char *m_names[];
static char *o_names[] = {mesg[138], mesg[139], mesg[140], mesg[141], mesg[142],
