...
mac macs[] = {
	{ "pc98", "1b5b3e356c/1b5b3e3568", "1b29301b5b3e336c1b5b3e3168",
         "1b5b3e316c", 2								},
	{"pc100", "1b5b3e3568/1b5b3e356c", "1b29301b5b3d33681b5b3e316c",
         "1b5b3e3168", 0								},
...
char *colorstr[2][NCOLORS] = {
	{"", "\033[m",   "\033[m",   "\033[m",   "\033[m",   "\033[m","\033[7m",
         "\033[7m",    "\033[7m",    "\033[7m"                 },
	{"", "\033[m", "\033[32m", "\033[33m", "\033[35m", "\033[36m",
         "\033[32;7m", "\033[33;7m", "\033[35;7m", "\033[36;7m"}
};
...
char *msg[NMESGS] = {
	...
	"よかったら、また遊んでくださいね？　　\003 Presented by Junn Ohta "
	"1989"};
