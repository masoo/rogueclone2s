...
void message(char *msg, bool intrpt)
{
...
int input_line(int row, int col, char *insert, char *buf, int ch)
{
    return do_input_line(0, row, col, "", insert, buf, "", 0, 1, ch);
}

int do_input_line(bool is_msg, int row, int col, char *prompt, char *insert,
...
int r_index(char *str, int ch, bool last)
{
    int i;
