...
extern void addstr(register char *str);
extern void addch(register int ch);
extern void mvaddch(short row, short col, int ch);
extern void touch(register int row, int bcol, int ecol);
extern void refresh(void);
extern void wrefresh(WINDOW *scr);
extern int mvinch(register short row, register short col);
...
extern void put_cursor(register int row, register int col);
extern void put_st_char(register int ch);
